...
rotasDados.get("/tabelas", async (req: express.Request, res: express.Response) => {
    try {
        const tabelas = await dependenciasDados.buscarTabelasBanco();
...
rotasDados.get("/pacientes", async (req: express.Request, res: express.Response) => {
    try {
        const pacientes = await dependenciasDados.buscarPacientes();
...
rotasDados.get("/paciente", async (req: express.Request, res: express.Response) => {
    try {
        const cpfOrName = req.query.cpf_or_name as string;
        const pacientes = await dependenciasDados.buscarPaciente(cpfOrName);
 ...
 */
rotasDados.post("/patients_exists", async (req: express.Request, res: express.Response) => {
    try {
        const idsCadastrados = await dependenciasDados.patientsExists(req.body);
 ...
 * Resposta: lista dos id_unico encontrados na base.
 */
rotasDados.post("/doctors_exists", async (req: express.Request, res: express.Response) => {
    try {
        const idsCadastrados = await dependenciasDados.doctorsExists(req.body);
        return responderSucesso(res, idsCadastrados);
    } catch (error) {
        console.error(error);
...
rotasDados.post("/adicionarPaciente", async (req: express.Request, res: express.Response) => {
    try {
        const paciente = await dependenciasDados.adicionarPaciente(req.body);
...
rotasDados.patch("/atualizarPacientes", async (req: express.Request, res: express.Response) => {
    try {
        const pacientes = await dependenciasDados.atualizarPacientes(req.body.pacientes);
        return responderSucesso(res, pacientes);
    } catch (error) {
        console.error(error);
...
rotasDados.get("/agendamentoPorId", async (req: express.Request, res: express.Response) => {
    try {
        const id_unico = req.query.id_unico as string;
        const agendamento = await dependenciasDados.buscarAgendamentoPorId(id_unico);
...
rotasDados.get("/agendamentos", async (req: express.Request, res: express.Response) => {
    try {
        const start_date = req.query.start_date as string;
        const end_date = req.query.end_date as string;
        const agendamentos = await dependenciasDados.buscarAgendamentos(start_date, end_date);
...
rotasDados.get("/agendamento", async (req: express.Request, res: express.Response) => {
    try {
        ...
        const start_date = req.query.start_date as string;
        const end_date = req.query.end_date as string;
        const agendamentos = await dependenciasDados.buscarAgendamento(id_paciente, start_date, end_date);
...
rotasDados.patch("/atualizarStatusAgendamento", async (req: express.Request, res: express.Response) => {
    try {
        const { id_unico, status } = req.body;
        const agendamento = await dependenciasDados.atualizarStatusAgendamento(id_unico, status);
        return responderSucesso(res, agendamento);
    } catch (error) {
        console.error(error);
...
rotasDados.post("/adicionarAgendamentos", async (req: express.Request, res: express.Response) => {
    try {
        const agendamentos = await dependenciasDados.adicionarAgendamentos(req.body.agendamentos);
...
rotasDados.post("/adicionarAgendamento", async (req: express.Request, res: express.Response) => {
    try {
        const agendamento = await dependenciasDados.adicionarAgendamento(req.body);
...
rotasDados.patch("/atualizarAgendamentos", async (req: express.Request, res: express.Response) => {
    try {
        const agendamentos = await dependenciasDados.atualizarAgendamentos(req.body.agendamentos);
        return responderSucesso(res, agendamentos);
    } catch (error) {
        console.error(error);
...
rotasDados.post("/adicionarMedico", async (req: express.Request, res: express.Response) => {
    try {
        const medico = await dependenciasDados.adicionarMedico(req.body);
...
rotasDados.post("/adicionarMedicos", async (req: express.Request, res: express.Response) => {
    try {
        const medicos = await dependenciasDados.adicionarMedicos(req.body.medicos);
...
rotasDados.patch("/atualizarMedicos", async (req: express.Request, res: express.Response) => {
    try {
        const medicos = await dependenciasDados.atualizarMedicos(req.body.medicos);
...
rotasDados.get("/medicos", async (req: express.Request, res: express.Response) => {
    try {
        const medicos = await dependenciasDados.buscarMedicos();
        return responderSucesso(res, medicos);
    } catch (error) {
        console.error(error);
...
rotasDados.post("/adicionarAgenda", async (req: express.Request, res: express.Response) => {
    try {
        const agenda = await dependenciasDados.adicionarAgenda(req.body);
...
rotasDados.get("/agendas", async (req: express.Request, res: express.Response) => {
    try {
        const agendas = await dependenciasDados.buscarAgendas();
...
rotasDados.patch("/atualizarAgendas", async (req: express.Request, res: express.Response) => {
    try {
        const agendas = await dependenciasDados.atualizarAgendas(req.body.agendas);
        return responderSucesso(res, agendas);
    } catch (error) {
        console.error(error);
...
rotasDados.post("/reverterSincronizacao", async (req: express.Request, res: express.Response) => {
    try {
        await dependenciasDados.reverterSincronizacao(req.body);
...
rotasDados.get("/buscarTableCron", async (req: express.Request, res: express.Response) => {
    try {
        const cronTables = await dependenciasDados.buscarTableCron();
...
rotasDados.get("/clinicas", async (_req: express.Request, res: express.Response) => {
    try {
        const clinicas = await dependenciasDados.listarClinicas();
...
rotasDados.get("/clinica", async (req: express.Request, res: express.Response) => {
    try {
        const id = String(req.query.id ?? "").trim();
        const clinica = await dependenciasDados.buscarClinicaPorId(id);

        if (!clinica) {
            return responderErro(res, "Clínica não encontrada", 404);
        }

        return responderSucesso(res, clinica);
    } catch (error) {
        console.error(error);
