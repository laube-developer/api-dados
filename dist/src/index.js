...
import { atualizarPacientes, ErroValidacao as ErroValidacaoAtualizacaoPacientes, ErroNaoEncontrado as ErroNaoEncontradoPacientes } from '../database/pacientes/atualizarPacientes.js';
...
import { buscarAgendamentoPorId, ErroValidacao as ErroValidacaoBuscaAgendamentoPorId } from '../database/agendamentos/buscarAgendamentoPorId.js';
import { reverterSincronizacao, ErroValidacao as ErroValidacaoReversao } from '../database/sincronizacao/reverterSincronizacao.js';
...
import { atualizarStatusAgendamento, ErroValidacao as ErroValidacaoAtualizacao, ErroNaoEncontrado } from '../database/agendamentos/atualizarStatusAgendamento.js';
import { atualizarAgendamentos, ErroValidacao as ErroValidacaoAtualizacaoAgendamentos, ErroNaoEncontrado as ErroNaoEncontradoAgendamentos } from '../database/agendamentos/atualizarAgendamentos.js';
...
import { atualizarMedicos, ErroValidacao as ErroValidacaoAtualizacaoMedicos, ErroNaoEncontrado as ErroNaoEncontradoMedicos } from '../database/medicos/atualizarMedicos.js';
...
import { atualizarAgendas, ErroValidacao as ErroValidacaoAtualizacaoAgendas, ErroNaoEncontrado as ErroNaoEncontradoAgendas } from '../database/agendas/atualizarAgendas.js';
...
app.patch('/atualizarPacientes', async (req, res) => {
    try {
...
app.get('/agendamentoPorId', async (req, res) => {
    try {
...
app.patch('/atualizarStatusAgendamento', async (req, res) => {
    try {
...
app.post('/adicionarAgendamentos', async (req, res) => {
    try {
...
app.patch('/atualizarAgendamentos', async (req, res) => {
    try {
...
app.post('/adicionarMedico', async (req, res) => {
    try {
...
app.post('/adicionarMedicos', async (req, res) => {
    try {
...
app.patch('/atualizarMedicos', async (req, res) => {
    try {
...
app.post('/adicionarAgenda', async (req, res) => {
    try {
...
app.patch('/atualizarAgendas', async (req, res) => {
    try {
...
app.post('/reverterSincronizacao', async (req, res) => {
    try {
