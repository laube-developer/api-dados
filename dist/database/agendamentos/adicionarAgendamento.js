...
export function normalizarDadosAgendamento(dados) {
    return {
        ...dados,
        insurance_id: typeof dados.insurance_id === "string" ? dados.insurance_id.trim() : "",
    };
}
export function validarDadosAgendamento(dados) {
    const erros = [];
    const camposTexto = [
        "id_agenda",
        "id_unico",
...
export function criarPropriedadesNotionAgendamento(dados) {
    const cpfNormalizado = normalizarCpf(dados.cpf_paciente);
    return {
        id_agenda: {
...
export function mapearPaginaParaAgendamento(page) {
...
export async function adicionarAgendamento(dados) {
...
//# sourceMappingURL=adicionarAgendamento.js.map